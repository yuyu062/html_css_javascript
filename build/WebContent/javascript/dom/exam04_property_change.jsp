      ...
      <title>Insert title here</title>
	   ...
	   <script>
      		function changePropertyValue(){
      			...
      			photoEl.src = "../../common/image/photo/photo2.jpg";
      		}		
      		
      		function handleMouseOver(){
      			var photoEl = document.querySelector("#photo");
      			photoEl.src = "../../common/image/photo/photo3.jpg";
      		}

      		function handleMouseOut(){
      			var photoEl = document.querySelector("#photo");
      			photoEl.src = "../../common/image/photo/photo1.jpg";
      		}
      		
      		function changeStyle(){
      			var colorBox1El =document.querySelector("#colorBox1");
      			colorBox1El.style.backgroundColor="orange";
      			colorBox1El.style.border="3px solid red";
      		}
      		
      		function changeClass(){
      			var colorBox2El = document.querySelector("#colorBox2");
      			colorBox2.classList.add("bg-warning");
      			colorBox2.classList.add("ml-5");
      		}
       </script>
   </head>
   <body>

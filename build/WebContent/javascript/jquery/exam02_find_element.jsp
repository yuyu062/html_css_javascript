   ...
   <body>
   	<div  class="p-3">
   	   <button class="btn btn-info btn-sm" onclick="findBySkillCheck()">
   	   		joinForm 내부에 name="skill""인 것 중에서 checked 속성이 있는 것을 찾기
   	   </button>
   	   <script>
   	   		function findBySkillCheck(){
   	   			var $checkedSkills = $("#joinForm [name=skill]:checked");
   	   				$checkedSkills.each(function(index, el){
	   	   			//console.log(el.value);
	   	   			//console.log($(el).val());
	   	   			//console.log($(this).value); //JQuery 객체로 변환해서 쓰겠다
		  	...
		  	<button class="btn btn-info btn-sm" onclick="findByCitySelected()">
	   	    ...
	   	    <script>
	   	   		function findByCitySelected(){
	   	   			var $selectedCity = $("#joinForm [name=city] option:checked");
